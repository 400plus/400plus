...
char *menuoptions_btnactn_strings[SHORTCUT_ACTION_COUNT] = {
	[SHORTCUT_ACTION_NONE]         = LP_WORD(L_V_NONE),
	[SHORTCUT_ACTION_ISO]          = LP_WORD(L_V_INTISO),
	[SHORTCUT_ACTION_SCRIPT]       = LP_WORD(L_V_REPEAT),
	[SHORTCUT_ACTION_MLU]          = LP_WORD(L_I_MIRROR_LOCKUP),
	[SHORTCUT_ACTION_AEB]          = LP_WORD(L_I_AEB),
	[SHORTCUT_ACTION_HACK_MENU]    = LP_WORD(L_V_HACK_MENU),
	[SHORTCUT_ACTION_TOGGLE_FLASH] = LP_WORD(L_V_TOGGLE_FLASH),
#ifdef DEV_BTN_ACTION
	[SHORTCUT_ACTION_DEV_BTN]      = "DevBtn (DO NOT USE)",
#endif
};
