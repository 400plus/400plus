...
//		[L_USE_FLASH]       = "Blitz benutzen",
	...
	[LANG_ITALIAN] = {
		...
		[L_LOAD_PRESETS]  = "Carica preset",
		[L_SAVE_PRESETS]  = "Salva preset",
		...
		[L_FLASH_COMP]      = "Comp. Flash",
		[L_AEB]             = "AEB",
		[L_ISO_IN_VF]       = "ISO in mirino",
		[L_SHORTCUTS_MENU]  = "Shortcuts menu",
		[L_SAFETY_SHIFT]    = "Safety Shift",
		[L_COLOR_TEMP_K]    = "Temp. Colore (K)",
		[L_USE_FLASH]       = "No flash",
		[L_HANDWAVE]        = "HandWave",
		[L_TIMER_SPACES]    = "Timer   ",
		[L_IR_REMOTE_DELAY] = "Ritardo IR",
		[L_DEVELOPERS_MENU] = "Menu Sviluppatori",

		[L_SCRIPTS_SPACES]  = "Scripts ",
		[L_DIM_LCD_DOWN]    = "LCDbasso",
		[L_KEEP_POWER_ON]   = "No APO  ",

		[L_SHORTCUTS]      = "ACC.DIRETTO",
		[L_ISO]            = "ISO",
		...
		[L_FLASH_2ND_CURT] = "Flash 2tend.",

		[L_PRESETS_SPACES]   = "Preset ",
		[L_PRESETS_ADEP]     = "Usa A-DEP",
