...
void menu_shortcuts_save() {
	...
	send_to_intercom(EVENT_SET_CF_MIRROR_UP_LOCK,  1, shortcuts_storage.CfMLU);
	send_to_intercom(EVENT_SET_CF_FLASH_SYNC_REAR, 1, shortcuts_storage.CfFlashSyncRear);
