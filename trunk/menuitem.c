...
OPTIONLIST_DEF(action,    LP_WORD(L_V_ONE_SHOT), LP_WORD(L_V_EXT_AEB), LP_WORD(L_V_EFL_AEB), LP_WORD(L_V_ISO_AEB))
OPTIONLIST_DEF(logfile,   LP_WORD(L_V_OVERWRITE), LP_WORD(L_V_NEW), LP_WORD(L_V_APPEND));
OPTIONLIST_DEF(btnactn,   LP_WORD(L_V_NONE), LP_WORD(L_V_INTISO), LP_WORD(L_V_REPEAT));
